...
# example
# full run to collect kernel approximation error: python launch_jobs_lp_rff_large_exp_collect_kernel_error.py census lp_rff/full_run_kernel_approx_error starcluster with_metric cuda -1 dryrun early_stop 8 &
