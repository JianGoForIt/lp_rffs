        ...
        for feat_bit_in in 32 16 8 4 2 1
          do
            ...
            python run_model.py --model=ridge_regression --minibatch=250 --l2_reg=0.0 \
              ...
              --data_path=/dfs/scratch0/zjian/data/lp_kernel_data/census --opt=sgd --epoch=100 --do_fp_model --n_bit_feat=${feat_bit_in} --cuda \
              --save_path=/dfs/scratch0/zjian/lp_kernel/census_results_sgd_fp_model_lp_feat/fpsgd_lr_${lr}_seed_${seed}_feat_nbit_${feat_bit_in}
          done
      done
  done
