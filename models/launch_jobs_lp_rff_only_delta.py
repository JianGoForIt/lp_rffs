...
# example
# the command line arg nbit is not useful anymore
# for lp runs closed form real setting: python launch_jobs_lp_rff_only_delta.py census lp_rff/regression_real_setting_heldout_spectral_norm starcluster with_metric cpu dryrun real closed_form_sol -1 & 
# for covtype runs with lp rff setting: python launch_jobs_lp_rff_only_delta.py covtype lp_rff/real_classification_heldout_spectral_norm starcluster with_metric cuda dryrun real iterative 20000 
...
#nbit = sys.argv[7]
fixed_design = sys.argv[7]
closed_form = sys.argv[8]
n_subsample = sys.argv[9]
...
for seed in seed_list:
	for l2_reg in l2_reg_list:
		for nbit in ['8', '64', '4', '2', '1', '16']:
			for n_fp_rff in n_rff_feat_dict[nbit]:
				for lr in lr_list:
