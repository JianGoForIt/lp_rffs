...
# example
# full run lp rff lm halp: python launch_jobs_lp_rff_large_exp_lm_bit_center_sgd.py timit lm_bit_center_sgd/first_round_sweep starcluster without_metric cuda -1 dryrun early_stop &
