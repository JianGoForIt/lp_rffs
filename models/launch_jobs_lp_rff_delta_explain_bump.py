...
# for lp runs closed form real setting: python launch_jobs_lp_rff_delta_explain_bump.py census lp_rff/regression_real_setting_explain_bump dawn with_metric cpu dryrun 4 real closed_form_sol -1 &
