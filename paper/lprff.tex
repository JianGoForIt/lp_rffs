...
\paragraph{Validation} To empirically validate the effect of low-precision on relative spectral distance implied by Theorem~\ref{thm2}, we perform two targeted experiments: (1) Keeping the number of features constant, we measure $D_{\lambda}(K,\tK)$ for various levels of precision. 
...
\begin{figure}
	...
	\begin{tabular}{c c}
		...
		\includegraphics[width=0.58\linewidth]{figures/theory_fixed_memory.pdf} 
