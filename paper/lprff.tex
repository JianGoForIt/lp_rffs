...
\begin{figure}
	...
	\end{tabular}
	\caption{Empirical validation of Theorem \ref{thm2}.  We demonstrate that the optimal precision, in terms of lowest $\lambda$-spectral distance per bit, depends on the value of $\lambda$.}
