...
\begin{figure}
	\centering
	\begin{tabular}{@{\hskip -0.1in}c@{\hskip -0.1in}c@{\hskip 0in}}
%		\subfigure[Census heldout MSE]{\label{fig:census_mem} \includegraphics[width=0.3\linewidth]{figures/census_MSE_vs_n_memory.pdf} } \hfill
%		\subfigure[Census heldout MSE]{\label{fig:census_feat}\includegraphics[width=0.3\linewidth]{figures/census_MSE_vs_n_feat.pdf} } \hfill
%		\subfigure[CovType heldout error]{\label{fig:covtype_mem} \includegraphics[width=0.3\linewidth]{figures/covtype_error_vs_n_memory.pdf} } \hfill
%		\subfigure[CovType heldout error]{\label{fig:covtype_feat}\includegraphics[width=0.3\linewidth]{figures/covtype_error_vs_n_feat.pdf} } \hfill
...
%		(a) Census & (b) YearPred & (c) Covtype & (d) TIMIT \\
		...
		\includegraphics[height=0.35\linewidth]{figures/census_MSE_vs_n_feat_every_line.pdf} &
		\includegraphics[height=0.35\linewidth]{figures/census_MSE_vs_n_memory_every_line.pdf} \\
		\includegraphics[height=0.35\linewidth]{figures/yearpred_MSE_vs_n_feat_every_line.pdf} &
		\includegraphics[height=0.35\linewidth]{figures/yearpred_MSE_vs_n_memory_every_line.pdf} \\
		\includegraphics[height=0.35\linewidth]{figures/covtype_error_vs_n_feat_every_line.pdf} &
		\includegraphics[height=0.35\linewidth]{figures/covtype_error_vs_n_memory_every_line.pdf} \\
		\includegraphics[height=0.35\linewidth]{figures/timit_error_vs_n_feat_every_line.pdf} &
		\includegraphics[height=0.35\linewidth]{figures/timit_error_vs_n_memory_every_line.pdf} \\
	\end{tabular}
...
\begin{figure}
	...
	\begin{tabular}{@{\hskip -0.15in}c@{\hskip -0.15in}c@{\hskip -0.15in}}
		\includegraphics[height=0.35\linewidth]{figures/regression_l2_vs_f_norm_every_line.pdf} &
		\includegraphics[height=0.35\linewidth]{figures/classification_acc_vs_f_norm_every_line.pdf} \\
		\includegraphics[height=0.35\linewidth]{figures/regression_l2_vs_s_norm_every_line.pdf} &
		\includegraphics[height=0.35\linewidth]{figures/classification_acc_vs_s_norm_every_line.pdf} \\
		\includegraphics[height=0.35\linewidth]{figures/regression_l2_vs_delta_every_line.pdf} &
		\includegraphics[height=0.35\linewidth]{figures/classification_acc_vs_delta_every_line.pdf} \\
		\includegraphics[height=0.35\linewidth]{figures/regression_delta_vs_mem_every_line.pdf} &
		\includegraphics[height=0.35\linewidth]{figures/classification_delta_vs_mem_every_line.pdf} \\
	\end{tabular}
