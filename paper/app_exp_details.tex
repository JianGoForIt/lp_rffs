...
\begin{figure}
	...
	\begin{tabular}{c c}
		...
		\subfigure[$\lambda$-spectral distance and memory]{\label{fig:census_s_norm_all_line}  \includegraphics[width=0.33\linewidth]{figures/regression_l2_vs_s_norm_all_line.pdf} } \hfill \\
