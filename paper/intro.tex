...
\begin{itemize}
	\item We propose low-precision random Fourier features, and prove a generalization bound which accounts for the number of bits used per feature.
